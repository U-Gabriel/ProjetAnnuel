...
<html lang="en">
<head>
	<title>Connexion - Fairrepack</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="icon" type="image/png" href="../vendor/img/fRepackFav.png"/>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('../vendor/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="connexionC_process.php" method="POST">
