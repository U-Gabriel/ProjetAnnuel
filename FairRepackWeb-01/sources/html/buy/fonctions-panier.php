 ...
 * @param File $photoProfil
 * @return void
 */


function ajouterArticle($libelleProduit,$qteProduit,$prixProduit,$photoProduit,$idProduit){

   //Si le panier existe
   if (creationPanier() && !isVerrouille())
   {
      //Si le produit existe déjà on ajoute seulement la quantité
      $positionProduit = array_search($photoProduit,  $_SESSION['panier']['photoProduit']);
